class MachinesController < ApplicationController
  ...
  def index
    ...
    @workshops.each do |workshop|
      @markers[workshop.id] = Gmaps4rails.build_markers([workshop]) do |w, marker|
        marker.lat w.latitude
        marker.lng w.longitude
        marker.title w.maker.name
        # marker.infowindow workshop.owner_of
        # marker.picture({
